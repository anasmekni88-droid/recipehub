 ...
 */
final class Version20260508192144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, instructions LONGTEXT NOT NULL, temps_preparation INT NOT NULL, temps_cuisson INT DEFAULT NULL, difficulte VARCHAR(50) NOT NULL, nb_personnes INT NOT NULL, date_creation DATETIME NOT NULL, publiee TINYINT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, auteur_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_49BB639060BB6FE6 (auteur_id), INDEX IDX_49BB6390BCF5E72D (categorie_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
